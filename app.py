...
def get_market_data():
    ...
    - 'indicator_source': NEW! 'local' (default, uses pandas/ta) or 'twelvedata' (uses Twelve Data API).
    ...
    indicator_source = request.args.get('indicator_source', 'local').lower() # NEW parameter: default to 'local'
